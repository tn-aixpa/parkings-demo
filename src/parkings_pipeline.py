...
def myhandler(url):
    with pipeline_context() as pc:
        ...
        s4_to_db = pc.step(name="to_db",  function="to-db", action="job",inputs={"agg_di": s3_aggregate.outputs['parking_data_aggregated'],"parkings_di":s2_parking.outputs['parkings']},outputs={})
